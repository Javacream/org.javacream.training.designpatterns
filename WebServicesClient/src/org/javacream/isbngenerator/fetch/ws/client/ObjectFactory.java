 ...
 * generated in the org.javacream.isbngenerator.fetch.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GenerateNextIsbnResponse_QNAME = new QName("http://ws.isbngenerator.javacream.org/", "GenerateNextIsbnResponse");
    private final static QName _GenerateNextIsbn_QNAME = new QName("http://ws.isbngenerator.javacream.org/", "GenerateNextIsbn");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.javacream.isbngenerator.fetch.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.isbngenerator.javacream.org/", name = "GenerateNextIsbnResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.isbngenerator.javacream.org/", name = "GenerateNextIsbn")
